...
# Note: there are 6583 observations. This is 12 less than the in the asreview_result_sysrevemotprob.csv file I think this are cases that have NA on included in this dataframe but have False on the column rayyan in this dataframe. Have to check this in exploration_asreviewresultsfile.Rmd. It does not really matter that these cases are excluded for the simulation however. 

...
Need to create the file again as the final file above did not include the column abstracts. 
*Note csv. created below was not usable in asreview as for some reason it did not find any excluded papers (coded zero on the variable included). I do not know why this was the case but I have now done it a different way that does seem to work -> see code above from asreview_simulation3. 
```{r}

...
```{r}
# check if file already exists, if not, code will be run to create the file 
filenam5 <- "final_report_AvdH/bigrams_filter.RData"
...
```{r}
# check if file already exists, if not, code will be run to create the file 
filenam6 <- "final_report_AvdH/bigrams_filter_glove.RData"
...
```{r}
# check if file already exists, if not, code will be run to create the file 
filenam7 <- "final_report_AvdH/glove_embedding_final.RData"
...
```{r}
# check if file already exists, if not, code will be run to create the file 
filenam8 <- "final_report_AvdH/glove_embedding_bigrams.RData"
...
```{r}
# check if file already exists, if not, code will be run to create the file 
filenam9 <- "final_report_AvdH/w2v_embedding_final.RData"
...
```{r}
# check if file already exists, if not, code will be run to create the file 
filenam10 <- "final_report_AvdH/w2v_bigrams_embedding.RData"

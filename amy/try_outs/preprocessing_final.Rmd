...
# Steps in original manuscript up untill before the methodological filter is applied
...
# download English udpipe model. This has to be run done only once.
...
# check the unique number of documents after applying these preprocessing steps
length(unique(df_kw$doc_id))
# -> this is equal to the final number of unique documents after applying all the other filters. This is interesting because it means that 207 unique abstracts are dropped because they do not contain a noun or adjective.
...
df_check <- readRDS("/Users/amyvanderham/Documents/Research_Assistant_Rgit/veni_sysrev/amy/data_study2.RData")
